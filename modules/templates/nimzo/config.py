...
def semantic_formstyle(id, label, controls, help, *args, **kwargs):
    """ divs only """
    ...
    if args:
        print("Semantic Formstyle received additional args:", args,
              file=sys.stderr)

    if kwargs:
        print("Semantic Formstyle received additional keyword args:", kwargs,
              file=sys.stderr)
